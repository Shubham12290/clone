...
--
-- Host: localhost    Database: foreigl
-- ------------------------------------------------------
...
CREATE TABLE `orders` (
  ...
  CONSTRAINT `j` FOREIGN KEY (`customer_id`) REFERENCES `customers` (`customer_id`) ON DELETE CASCADE,
...
INSERT INTO `orders` VALUES (106,2,800);
