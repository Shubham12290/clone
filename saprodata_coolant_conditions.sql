...
--
-- Table structure for table `coolant_conditions`
--

DROP TABLE IF EXISTS `coolant_conditions`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `coolant_conditions` (
  ...
  `oil_grade` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `refractive_index` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
--
-- Dumping data for table `coolant_conditions`
--

LOCK TABLES `coolant_conditions` WRITE;
/*!40000 ALTER TABLE `coolant_conditions` DISABLE KEYS */;
/*!40000 ALTER TABLE `coolant_conditions` ENABLE KEYS */;
UNLOCK TABLES;
